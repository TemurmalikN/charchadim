...
> Открыть эту страницу в [https://temurmalikn.github.io/charchadim/](https://temurmalikn.github.io/charchadim/)
...
* найдите **https://github.com/temurmalikn/charchadim** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/temurmalikn/charchadim/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/temurmalikn/charchadim** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/temurmalikn/charchadim/raw/master/.github/makecode/blocks.png)
